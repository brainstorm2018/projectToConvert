$(function() {
    ...
    $('*[data-jquery-clock]').each(function() {
        ...
        var oldHoursAndMinutes = -1;

        var updateWatch = function updateWatch() {
            ...
            var hoursAndMinutes = (hours * 60) + mins;

            if (seconds !== oldSeconds){

                // Snap hand to where it should be before performing animation
                if (seconds - 1 !== oldSeconds) {

                    oldSeconds = seconds - 1;

                    $(".jquery-clock-sec").removeClass('jquery-clock-transitions');

                    var osdegree = (seconds - 1) * 6;
                    var osrotate = "rotate(" + osdegree + "deg)";
                    $(".jquery-clock-sec", t).css({
                        "-moz-transform": osrotate,
                        "-webkit-transform": osrotate,
                        '-ms-transform': osrotate
                    });
                    ...
                    $(".jquery-clock-sec").addClass('jquery-clock-transitions');
            ...
            if (mins !== oldMinutes) {
                ...
                // Snap hand to where it should be before performing animation
                if (mins - 1 !== oldMinutes) {

                    oldMinutes = mins - 1;

                    $(".jquery-clock-min").removeClass('jquery-clock-transitions');

                    var omdegree = (mins - 1) * 6;
                    var omrotate = "rotate(" + omdegree + "deg)";
                    $(".jquery-clock-min", t).css({
                        "-moz-transform": omrotate,
                        "-webkit-transform": omrotate,
                        '-ms-transform': omrotate
                    });
                    ...
                    $(".jquery-clock-min").addClass('jquery-clock-transitions');
            ...
            if (hoursAndMinutes !== oldHoursAndMinutes) {

                // Snap hand to where it should be before performing animation
                if (hoursAndMinutes - 1 !== oldHoursAndMinutes) {

                    oldHoursAndMinutes = hoursAndMinutes - 1;

                    $(".jquery-clock-hour").removeClass('jquery-clock-transitions');

                    var ohdegree = (hoursAndMinutes - 1) / 2;
                    var ohrotate = "rotate(" + ohdegree + "deg)";
                    $(".jquery-clock-hour", t).css({
                        "-moz-transform": ohrotate,
                        "-webkit-transform": ohrotate,
                        '-ms-transform': ohrotate
                    });

                } else {

                    oldHoursAndMinutes = hoursAndMinutes;

                    $(".jquery-clock-hour").addClass('jquery-clock-transitions');

                    var hdegree = hoursAndMinutes / 2;
            ...
            window.requestAnimationFrame(updateWatch);
        }
        updateWatch();
