    ...
    if ($('.js-switch').length){
        setTimeout(function(){
            $('.js-switch').each(function () {
                ...
                if(colorOn == 'green') colorOn = '#43d7b7';
                ...
                if(colorOff == 'green') colorOff = '#43d7b7';
...
function handleiCheck() {
    ...
    if (!$().iCheck)  return;
    $(':checkbox:not(.js-switch, .switch-input, .switch-iphone, .onoffswitch-checkbox, .ios-checkbox, .needs-unique-icheck), :radio').each(function() {
...
//                 jQuery('#txtDateTo').datepicker('show');
//             }, 0);
//         }
//     })
//
...
//         showButtonPanel: false,
//         onSelect: function () {
//             $('.filter-by-box1').removeClass('active');
//             $('.refresh-main-table').trigger('click')
//         }
//     })
//
// };
