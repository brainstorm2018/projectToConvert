        ...
        var seriesOptions = [],
            ...
            createChart = function () {
                ...
                $('#financial-chart').highcharts('StockChart', {
                    ...
                    colors: ['#26B5FF', '#f7a35c', '#787EE9', '#f15c80', '#91e8e1'],
                    credits: {
                        enabled: false
                    },
                    exporting: {
                ...
                $('#financial-chart1').highcharts('StockChart', {
                    chart: {
                        height:130,
                        borderColor: '#C9625F',
                        backgroundColor: 'transparent'
                ...
                $('#financial-chart2').highcharts('StockChart', {
                    chart: {
                        height:130,
                        borderColor: '#C9625F',
                        backgroundColor: 'transparent'
                ...
                $('#financial-chart3').highcharts('StockChart', {
                    chart: {
                        height:130,
                        borderColor: '#C9625F',
                        backgroundColor: 'transparent'
